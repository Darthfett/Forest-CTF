...
library Repick //initializer Init -- Initialized by Game
    ...
    public function init takes nothing returns nothing
        local integer i = 0
        call BJDebugMsg("Create Units")
        set ASSASSIN.model = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'E002', 3348.2, 6799.0, 180.000)
        set HUNTER.model = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'E005', 2903.8, 7291.3, 240.000)
        set MAGE.model = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'E004', 3338.5, 7077.1, 205.000)
        set PALADIN.model = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'E000', 3165.6, 7304.1, 225.000)
        set ROGUE.model = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'E001', 2645.4, 7273.4, 255.000)
        set WARRIOR.model = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'E003', 3346.9, 6503.6, 188.309)
        loop
            exitwhen i >= 12
