library Game uses AIDS, Data, stringFind, stringPlayer, Powerups, Repick, UnitType
    ...
    */
        ...
        private static method setup takes nothing returns nothing
            ...
            */
            ...
            local integer i = 0
            call BJDebugMsg("6 Rogue: " + Rawcode2String(ROGUE.whichType))
            loop
                exitwhen i >= 12
        ...
        private static method initCategories takes nothing returns nothing
            ...
            */
            ...
            call UnitType.initHeroes.execute()
        ...
        private static method selectOptions takes nothing returns nothing
            ...
            */
            ...
            call BJDebugMsg("2 Rogue: " + Rawcode2String(ROGUE.whichType))
        ...
        private static method loadCredits takes nothing returns nothing
            ...
            */
            call BJDebugMsg("Rogue Rawcode 2: " + I2S(ROGUE.whichType))
